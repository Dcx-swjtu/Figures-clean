...
data_math_by_category = {
    ...
    "result": {
        "Standard": np.array(
            [0.253623188, 0.5, 0.5, 0.594202899, 0.688405797, 0.710144928, 0.789855073]
        ),
        "Geometry": np.array(
            [0.125, 0.416666667, 0.375, 0.291666667, 0.375, 0.541666667, 0.666666667]
        ),
        ...
        "Combinatorics": np.array(
            [0.25, 0.416666667, 0.416666667, 0.625, 0.666666667, 0.625, 0.75]
        ),
        "Algebra": np.array(
            [
                0.196428571,
        ...
        "Pattern": np.array(
            [0, 0.214285714, 0.178571429, 0.357142857, 0.642857143, 0.428571429, 0.75]
        ),
        "Arithmetic": np.array(
            [0, 0.333333333, 0.166666667, 0.5, 0.722222222, 0.555555556, 0.888888889]
        ),
    },
}
...
data_logic_by_category = {
    ...
    "result": {
        ...
        "Tree": np.array(
            [0.166666667, 0, 0, 0.166666667, 0.166666667, 0.166666667, 0.5]
        ),
        "Complex/small": np.array(
            [0, 0.433333333, 0.4, 0.466666667, 0.566666667, 0.833333333, 0.866666667]
        ),
        "Liars": np.array(
            [
                0,
        ...
        "Compound": np.array(
            [0, 0.444444444, 0.555555556, 0.666666667, 0.555555556, 0.888888889, 1]
        ),
        "Math-like": np.array(
            [
                0.085714286,
        ...
        "Linguistic": np.array(
            [0, 0.066666667, 0.066666667, 0.466666667, 0.4, 0.2, 0.8]
        ),
    },
}
...
if __name__ == "__main__":
    ...
    for subtype_idx, subtype_name in enumerate(data_math_by_category["subtypes"]):
        ...
        ax.set_title(
            data_math_by_category["subtypes"][subtype_idx], fontsize=36, pad=36
        )
    ...
    for subtype_idx, subtype_name in enumerate(data_logic_by_category["subtypes"]):
        ...
        ax.set_title(
            data_logic_by_category["subtypes"][subtype_idx], fontsize=36, pad=36
        )
        ax.set_ylabel("Probability", fontsize=30, labelpad=12)
        ax.set_ylim([0, 1])
        ax.set_xticks([])
