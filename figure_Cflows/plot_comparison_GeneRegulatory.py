...
data_comparison_GeneRegulatory = {
    ...
    "std": {
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (100, 137)": np.array(
            [3.5, 3.9, 2.4, 3.3, 6.2, 8.6, 13.8, 3.2, 3.3]
        ),
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (150, 329)": np.array(
            [2.9, 3.7, 2.2, 4.0, 5.4, 12.4, 19.3, 2.8, 6.4]
        ),
        r"($|\mathcal{V}|$, $|\mathcal{E}|$) = (200, 507)": np.array(
            [1.1, 6.5, 8.8, 6.2, 13.4, 23.6, 7.0, 11.6, 12.6]
        ),
    },
}
...
if __name__ == "__main__":
    ...
    for dataset_idx, dataset_name in enumerate(
        data_comparison_GeneRegulatory["datasets"]
    ):
        ...
        ax.set_xticks([])
        ax.set_ylabel(
            data_comparison_GeneRegulatory["metric"], fontsize=36, labelpad=12
        )
